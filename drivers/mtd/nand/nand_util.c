...
int nand_erase_opts(nand_info_t *meminfo, const nand_erase_options_t *opts)
{
	...
	{
		if (opts->flag == 2)   //内核进度条
		{
			embedsky_Write_Progress_note(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*2,LCD_BAR_LONG,1,LCD_BAR_ANNOTATE_COLOUR,"Download zImage images.");
		}
		else if (opts->flag == 1)  //logo进度条 
		{
			embedsky_Write_Progress_note(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*1,LCD_BAR_LONG,1,LCD_BAR_ANNOTATE_COLOUR,"Download logo images.");
		}
		else if (opts->flag == 3)  //bootloader进度条 
		{
			embedsky_Write_Progress_note(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*0,LCD_BAR_LONG,1,LCD_BAR_ANNOTATE_COLOUR,"Download bootloader images.");
		}
		else if (opts->flag == 4)  //rootfs进度条 
		{
			embedsky_Write_Progress_note(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*3,LCD_BAR_LONG,1,LCD_BAR_ANNOTATE_COLOUR,"Download rootfs images.");
		}
	}
	else
	{
		if (opts->flag == 2)   //内核进度条
		{
			embedsky_Write_Progress_note(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*3,LCD_BAR_LONG,1,LCD_BAR_ANNOTATE_COLOUR,"Download zImage images.");
		}
		else if (opts->flag == 1)  //logo进度条 
		{
			embedsky_Write_Progress_note(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*3,LCD_BAR_LONG,1,LCD_BAR_ANNOTATE_COLOUR,"Download logo images.");
		}
		else if (opts->flag == 3)  //bootloader进度条 
		{
		...
		if (!opts->quiet) {
			...
			if (percent != percent_complete) {
				...
				if (LCD_XSIZE_TFT == 800)
				{
					if (opts->flag == 2)   //内核进度条
					{
						embedsky_paint_Progress_bar(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*2+16+LCD_BAR_NOTE,LCD_BAR_WIDTH,LCD_BAR_LONG,percent,LCD_BAR_COLOUR);
					}
					else if (opts->flag == 1)  //logo进度条 
					{
						embedsky_paint_Progress_bar(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*1+16+LCD_BAR_NOTE,LCD_BAR_WIDTH,LCD_BAR_LONG,percent,LCD_BAR_COLOUR);
					}
					else if (opts->flag == 3)	//bootloader进度条
					{
						embedsky_paint_Progress_bar(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*0+16+LCD_BAR_NOTE,LCD_BAR_WIDTH,LCD_BAR_LONG,percent,LCD_BAR_COLOUR);
					}
					else if (opts->flag == 4)	//rootfs进度条
					{
						embedsky_paint_Progress_bar(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*3+16+LCD_BAR_NOTE,LCD_BAR_WIDTH,LCD_BAR_LONG,percent,LCD_BAR_COLOUR);
					}
				}
				else
				{
...
int nand_write_opts(nand_info_t *meminfo, const nand_write_options_t *opts)
{
	...
	if (LCD_XSIZE_TFT == 800)
	{
		if (opts->flag == 2)   //内核进度条
		{
			...
			embedsky_Write_Progress_note(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*2,LCD_BAR_LONG,0,LCD_BAR_ANNOTATE_COLOUR,"Succeed!");
		}
		else if (opts->flag == 1)  //logo进度条 
		{
			...
			embedsky_Write_Progress_note(LCD_BAR_START_X,LCD_BAR_START_Y+LCD_WIDE_BAR*1,LCD_BAR_LONG,0,LCD_BAR_ANNOTATE_COLOUR,"Succeed!");
		}
		else if (opts->flag == 4)  //rootfs进度条 
		{
...
#ifdef CONFIG_EmbedSky_LCD
		//embedsky_paint_Progress_bar(0,0,0,0,100-(left_to_write/(*length/100)),0xff);
#endif /* CONFIG_EmbedSky_LCD */
